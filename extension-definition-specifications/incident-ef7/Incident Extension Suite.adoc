...
|[stixtype]#<<incident-investigation-ov,incident-investigation-ov>>#
...
As such every Impact *MUST* have one and only one extension which has the same value as the *impact_category* property.
...
*Type Name:* [stixtype]#availability-impact-ext#
...
*Type Name:* [stixtype]#confidentiality-impact-ext#
...
*Type Name:* [stixtype]#external-impact-ext#
...
*Type Name:* [stixtype]#integrity-impact-ext#
...
*Type Name:* [stixtype]#monetary-impact-ext#
...
*Type Name:* [stixtype]#physical-impact-ext#
...
*Type Name:* [stixtype]#traceability-impact-ext#
