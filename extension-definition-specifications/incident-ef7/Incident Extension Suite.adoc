...
|[stixtype]#{string_url}[string]#
|The category to which the impact belongs. If the category is one of the defined extensions from section 2.3.2 are used (availability, confidentiality, integrity, economic, external, traceability) it *MUST* be specified. The value *MUST* be specified without the "-ext" suffix. 
