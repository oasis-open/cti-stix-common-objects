...
|A list of activities that this activity was composed of.
The object is defined in Incident Activity Extension Version 1.0 for STIX^TM^ Version 1.0.
...
|[stixtype]#list# of type [stixtype]#impact#
