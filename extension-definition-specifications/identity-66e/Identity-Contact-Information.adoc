...
[.stix-doc-information-heading]#21 January 2025#
...
|*websites* (optional)
|[stixtype]#{list_url}[list]# of type [stixtype]#{string_url}[string]#
|A list of websites associated with the identity.
