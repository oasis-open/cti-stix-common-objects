...
=== 3. Identity Contact Information Examples

==== 3.1 Incident Contact Details Example
[source,json]
----
include::examples/contact_details.json[]
----

==== 3.2 Identitiy Contact Details Example
[source,json]
----
include::examples/individual_contact_example.json[]
----

==== 3.3 Organization Contact Details Example
[source,json]
----
